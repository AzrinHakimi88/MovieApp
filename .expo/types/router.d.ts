...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/HomePage` | `/PopularMovie` | `/PopularShow` | `/_sitemap` | `/movieDetail/MovieDetail` | `/showDetail/ShowDetail`;
  type DynamicRoutes<T extends string> = `/details/${SingleRoutePart<T>}/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/details/[type]/[id]`;
